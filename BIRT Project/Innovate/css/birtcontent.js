 ...
 */
	if (acStyle == "dashboardStyle1") {
		...
		if(acDisplay2 == "navbar") {
			$('#menu-edit-dashboard').toggleClass("shownavbar");			
		};
...
$('#menu-edit-dashboard').click(function(e) {
	...
	if (acStyle=="dashboardStyle1") {
		if ($("#menu-add-dashboard").length==0) {
			// hide "New Tab" button		
			$('.actuate-dashboard-tab-panel-tool-plus').css('display','none');
			// add a fake plus button
			$( '<li id="menu-add-dashboard" class="actuate-dashboard-tab-panel-tool actuate-dashboard-tab-panel-tool-plus-bis"></li>').insertAfter( ".actuate-dashboard-tab-panel-tool-plus" );
			$('#menu-add-dashboard').bind("click", function(e) {
	...
	// Show/Hide toolbar
	} else if (acStyle=="dashboardStyle2") {
		viewer.showToolbar(true);
	}
});
/*
